...
<head>
  ...
  <link href="assets/<?php echo $manifest->{'app.css'} ?>" rel="stylesheet"></head>
</head>
<body>
  <h1>Home 2</h1>
  ...
  <script type="text/javascript" src="assets/<?php echo $manifest->{'app.js'} ?>"></script><script type="text/javascript" src="assets/contact.cd7810e01bd28fd363ae.js"></script></body>
